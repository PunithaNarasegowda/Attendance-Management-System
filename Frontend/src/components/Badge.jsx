...
const badgeVariants = {
  variant: {
    ...
    success:
      "border-transparent bg-[linear-gradient(90deg,#34D399,#10B981)] text-white [a&]:hover:opacity-95",
    warning: "border-transparent bg-yellow-100 text-yellow-800 [a&]:hover:bg-yellow-200",
    info:
      "border-transparent bg-[linear-gradient(90deg,#22D3EE,#38BDF8)] text-[#062A33] [a&]:hover:opacity-95",
  },
};

const Badge = ({ children, variant = 'default', className = '', asChild = false, ...props }) => {
